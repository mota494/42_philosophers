...
SRC = sources/philo_check.c sources/error_handle.c sources/main.c sources/utils.c sources/utils2.c sources/utils3.c sources/init.c sources/debug.c sources/sim.c sources/actions.c
#commands
RM = rm -rf
OBJ = $(SRC:.c=.o)
#includes
